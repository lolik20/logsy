...
<p>Политика разработана в соответствии с Федеральным законом от 27.07.2006 № 152-ФЗ «О персональных данных» и published в открытом доступе согласно части 2 статьи 18.1 указанного закона.</p>
