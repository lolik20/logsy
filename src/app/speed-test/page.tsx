...
const steps = [
  {
    ...
    text: "Как быстро сервер начинает отвечать — сразу видно, тормозит бэкенд или нет.",
    icon: "⚡",
  },
  {
    title: "Полное время загрузки",
    text: "Сколько заняла полная загрузка ответа от сервера — итоговая скорость.",
    icon: "⏱️",
  },
  {
    title: "Размер и статус ответа",
    text: "Объём загруженных данных и HTTP-код — есть ли переадресации и ошибки.",
    icon: "📦",
  },
];
      ...
      <section className="relative z-10 mx-auto max-w-3xl px-6 pb-16 pt-16">
        <div className="text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-lg text-slate-600 dark:text-slate-300">
            Введите адрес сайта — мы сделаем запрос и измерим время загрузки:
            время до первого байта, полное время и размер ответа.
          </p>
        </div>
