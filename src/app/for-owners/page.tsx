...
const pains = [
  {
    ...
    text: "Платёжный шлюз вернул ошибку, а вы узнаёте об этом вечером по пустым продажам. Каждый час простоя checkout — это десятки несостоявшихся заказов.",
  },
  {
    icon: "🚪",
    title: "Клиент ушёл и не вернулся",
    text: "После одной ошибки на сайте почти 8 из 10 посетителей уходят к конкуренту и не возвращаются. Вы платили за этот трафик — и потеряли его молча.",
  },
  {
    icon: "🕐",
