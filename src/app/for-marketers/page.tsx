...
export const metadata: Metadata = {
  title: "Мониторинг лендингов для маркетологов — бюджет не в ошибки",
  description:
...
const stats = [
  { value: "1 строка", label: "в <head> лендинга — подключение без разработчика" },
  { value: "UTM", label: "видите источник и кампанию каждой сессии" },
  { value: "0 ₽", label: "стоит найти баг, который ест бюджет: тариф бесплатный" },
